...
local function showLoadScreen()
    fonts.loadScreen = love.graphics.newFont("Art/font/SF Atarian System Bold.ttf", love.graphics.getHeight() / 5)
...
function love.load()
    showLoadScreen()
    require("Resources")
    fonts.pauseScreen = love.graphics.newFont("Art/font/SF Atarian System Bold.ttf", 100)
    fonts.statistics = love.graphics.newFont("Art/font/SF Atarian System Bold.ttf", 30)
    -- TODO: loadResources()
